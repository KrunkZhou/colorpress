...
Page({
  ...
  onShareAppMessage: function (res) {
    ...
    return {
      ...
      path: 'pages/video/video?id=' + this.data.detail.id,
  ...
  creatArticlePoster: function (appPage, api, util, modalView, poster) {
    ...
    var path = "pages/video/video?id=" + postId;
    var data = {
      postid: postId,
      path: path
    ...
    creatPosterRequest.then(res => {
      if (res.data.code == 'success') {
        ...
        var images = [{
            ...
            x: 0,
            y: 0,
            url: '/images/uploads/logobg.png', //海报主图
          },
          {
            width: 80,
            height: 80,
